      ...
      questions: [
        {
          ...
          options: [
            'Branch misprediction on the inner loop exit',
            'Every access jumping 64 KB — one cache line fetched per 8 bytes used, with no line reuse',
            'Integer overflow in the index arithmetic',
            'The compiler failing to vectorize column loops specifically',
          ],
          correct: [1],
          explanation:
        ...
        },
        {
          ...
          options: [
            'Small matrices use a different, faster memory bus',
            'The CPU reorders loops automatically for small arrays',
            'Once data is cache-resident, access order barely matters — the penalty is a DRAM-latency effect',
            'The prefetcher only works on small working sets',
          ],
          correct: [2],
          explanation:
        ...
        },
        {
          ...
          options: [
            'Random within a 4 KB page',
            'Sequential or constant small-stride, so it can predict and pre-fetch upcoming lines',
            'Strided by exactly one page (4 KB)',
            'Pointer-based, chasing linked nodes',
          ],
          correct: [1],
          explanation:
        ...
        },
        {
          ...
          options: [
            'The JIT refuses to optimize 2D loops',
            'Rows are separately heap-allocated objects; the walk pointer-chases across the heap with no contiguity guarantee',
            'Java arrays store a length field that breaks alignment',
            'Bounds checks cost more than cache misses',
          ],
          correct: [1],
          explanation:
